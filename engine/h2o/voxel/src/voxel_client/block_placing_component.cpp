...
namespace h2o
{
    ...
    //         m_input_module.key_state(Key::E).pressed_this_frame)
    //     {
    ...
    //         {
    //             if (m_input_module.mouse_button_state(MouseButton::Left).pressed_this_frame)
    //                 block_placeable->set_block_at(hit_voxel.pos, Block::Air);
    //
    //             if (m_input_module.mouse_button_state(MouseButton::Right).pressed_this_frame)
    //             {
