...
namespace h2o
{
    ...
    public:
        ...
        virtual void gen_blocks(ChunkView& region_view) const = 0;
        ...
        [[nodiscard]] virtual std::vector<VoxelStructureInstance> gen_structures(const ChunkView& region_view) const = 0;
